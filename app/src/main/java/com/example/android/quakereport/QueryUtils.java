...
public final class QueryUtils {
    ...
    public static ArrayList<Quake> extractEarthquakes() {
        ...
        try {
            ...
            /**
             * Parse the response given by the SAMPLE_JSON_RESPONSE string and build up a list of
             * Earthquake objects with the corresponding data.
             */
            ...
            for (int i = 0; i < featuresArray.length(); i++){
                ...
                String mag = propertiesJsonObject.optString("mag").toString();
